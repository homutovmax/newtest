...
# Include the MCLH-08 entities
entities = [
    "sensor.datchik_kachestva_vozdukha_temperature",
    "sensor.datchik_kachestva_vozdukha_humidity",
    "sensor.datchik_kachestva_vozdukha_voc",
    "sensor.datchik_kachestva_vozdukha_eco2"
]

print("=== Submitting entities to expose ===")
...
if result.get("type") == "external_step":
    ...
    print(f"  Description: {json.dumps(result.get('description_placeholders',{}), ensure_ascii=False)[:300]}")
